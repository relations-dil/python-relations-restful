...
class TestUnitTest(relations_restful.unittest.TestCase):
    ...
    def test_assertConsistent(self):
        ...
        with unittest.mock.patch('relations_restful.unittest.TestCase.assertEqual') as mock_equal:
    ...
    def test_assertContains(self):
        ...
        with unittest.mock.patch('relations_restful.unittest.TestCase.assertIn') as mock_in:
